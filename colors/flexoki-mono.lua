-- Flexoki Monochrome colorscheme
...
local function get_highlight_groups()
  ...
  return {
    ...
    IncSearch = { fg = c.bg, bg = c.ye, blend = 50 },
    CurSearch = { fg = c.bg, bg = c.ye, blend = 50 },
    Substitute = { fg = c.tx, bg = c.gr, blend = 50 },
    LineNr = { fg = c.tx_3, bg = c.bg_2 },
    ...
    Search = { fg = c.bg, bg = c.ye_2 },
    SignColumn = { fg = 'NONE', bg = c.bg_2 },
    ...
    Boolean = { fg = c.tx },
    Character = { fg = c.tx },
    Comment = { fg = vim.g.mono_color_comments and c.cy or c.tx_2, italic = false },
    Conditional = { fg = c.tx },
    Constant = { fg = c.tx },
    Define = { fg = c.tx },
    Float = { fg = c.tx },
...
local function setup()
  ...
  vim.g.colors_name = 'flexoki-mono'
