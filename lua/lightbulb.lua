...
-- Taken from https://github.com/MariaSolOs/dotfiles/blob/d38272d2a56e7edff3916d53b464da07ae993587/.config/nvim/lua/lightbulb.lua#L91

local M = {}

local lb_name = 'nequo/lightbulb'
local lb_namespace = vim.api.nvim_create_namespace(lb_name)
local lb_icon = require('icons').misc.lightbulb
...
local function update_extmark(bufnr, line)
  ...
  pcall(vim.api.nvim_buf_set_extmark, bufnr, lb_namespace, line, -1, {
    virt_text = { { ' ' .. lb_icon, 'DiagnosticSignWarn' } },
    hl_mode = 'combine',
  })
